...
// TODO - document it so we don't feel bad :)
...
func (s *Store) List(ctx context.Context) (_ []Migration, err error) {
	...
	if !ReturnEnterpriseMigrations {
		conds = append(conds, sqlf.Sprintf("NOT m.enterprise"))
	}

	//
	// TODO - compare first version major/minor against migrations as well
	//
